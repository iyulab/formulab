...
`formulab` is a zero-dependency, tree-shakeable TypeScript library of ~217 industrial/manufacturing calculation functions spread across 15 domains (quality, metal, chemical, electronics, construction, automotive, logistics, energy, safety, food, utility, battery, environmental, machining, ie). It ships as ESM only. Each function is a pure input→output calculation, often verified against a published engineering standard.
